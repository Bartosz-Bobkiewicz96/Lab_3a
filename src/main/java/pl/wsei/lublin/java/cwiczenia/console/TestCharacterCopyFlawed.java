...
public class TestCharacterCopyFlawed {
    public static void main (String[]args) throws IOException {
        ...
        try {
            ...
            out = new BufferedWriter(new FileWriter("img_copyCharacter.tiff"));
            int c;
        ...
        System.out.println("Czas wykonania zadania w nanosekundach: "+(Instant.now().toEpochMilli()-startTime));
